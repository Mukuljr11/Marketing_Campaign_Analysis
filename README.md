...
1)Which marketing campaigns generate the highest ROI?
2)Which channels are underperforming and wasting budget?
...
1)campaigns – Campaign metadata and budgets.
2)customers – Customer demographic and segmentation data.
3)campaign_performance – Daily campaign performance metrics.
4)customer_acquisition – Customer acquisition cost data.
...
3)North region contributed the highest share of total revenue
4)Returning customers had significantly lower acquisition costs
